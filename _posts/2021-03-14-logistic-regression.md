...
, where 
- ![p](https://render.githubusercontent.com/render/math?math=%5Ctextstyle+p) is the probability that ![y=1](https://render.githubusercontent.com/render/math?math=%5Ctextstyle+y%3D1),
